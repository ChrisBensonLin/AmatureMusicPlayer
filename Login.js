                    ...
                    <div className="row justify-content-end pb-30">
                        <div className="col-5">
                            <div className="bg-white-opacity-10 backdrop-blur p-12">
                                ...
                                <button className="btn btn-gradation btn-l w-100 mb-6" onClick={this.POST} type="submit" href="/index">登入</button>
                                <button className="btn btn-gradation btn-l w-100 mb-4" type="button"><span>使用 Google 登入</span></button>
