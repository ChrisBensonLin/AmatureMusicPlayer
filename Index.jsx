...
class Index extends Component {
          ...
          <section className=" container pt-20">
            ...
            <div className="scrollbar d-none d-md-block" id="style-3">
              {this.state.hotSong.map((item, idx) => (
                <ul onClick={this.clickMusic} data-num={item.MusicID} className="row pt-4 pb-3  px-8 border-bottom-secondery imgContainer cursor-pointer heartDiv">
                  ...
                  <li className="col-md-1 col-1  m-auto">
                    <button className="btn btn-black hvr-bounce-in" type="button" onClick={() => { this.changeHeart(item.MusicID) }}>
                  ...
                  <div className="col-2 me-8 ms-1" data-num={item.MusicID}>
                    <div className="drop">
                      ...
                      <div className="dropbox">
                        <button type="button" className="btn" data-num={item.MusicID} onClick={() => { this.changeHeart(item.MusicID) }}>
                          <img src="./images/icon/heart.png" alt="" className="heartIcon" />
                          <img src="./images/icon/heart2.png" alt="" className="heartIcon2 d-none" />收藏
                        </button>
              ...
              <div className="carousel-inner mySwiperActivityImg">
                <div className="carousel-item active" data-bs-interval="100000">
                  <div className="row px-20">
                    ...
                    <div className="activityContent col-md-4 mt-14">
                      ...
                      <NavLink to="/concert" className="btn btn-xl btn-gradation mt-10">
                        查看活動
                      </NavLink>
                    </div>
                  </div>
                ...
                <div className="carousel-item" data-bs-interval="100000">
                  <div className="row">
                    ...
                    <div className="activityContent col-md-4 mt-14">
                      <p className="fs-4">第八屆聲聲不熄創作選拔賽</p>
                      ...
                      <NavLink to="/contest" className="btn btn-xl btn-gradation mt-10">
                        查看活動
                      </NavLink>
                    </div>
                  </div>
                ...
                <div className="carousel-item" data-bs-interval="100000">
                  <div className="row">
                    ...
                    <div className="activityContent col-md-4 mt-10">
                      ...
                      <NavLink to="" className="btn btn-xl btn-gradation mt-10">
                        查看活動
                      </NavLink>
                    </div>
                  </div>
                  ...
                  {this.state.songList1.map((item, idx) => (
                    <div className="col-md-2 col-6 mt-10" onClick={this.clickMusic} data-num={item.MusicID}>
                      <div className="imgContainer">
                        ...
                        >
                          <p className="pt-8" data-num={item.MusicID}>{item.MusicName}</p>
  ...
  componentDidMount = async () => {
    let result = await Axios.get("http://localhost:9000/Limitmusic");
