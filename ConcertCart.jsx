...
class ConcertCart extends Component {
  ...
  render() {
    return (
      <section className="border border-2 border-dark rounded-8 mt-md-12 p-10">
            ...
            <div className="bg-white-opacity-5 p-4">
              ...
              <ul className="row align-items-center">
                ...
                <li className="col-md-3 offset-md-2">
                  <button type="button" className="btn btn-gradation btn-m w-100" data-bs-toggle="modal" data-bs-target="#buyTicket"><span>確認購買</span></button>
                </li>
              </ul>
            </div>
              ...
              <div className="modal-dialog modal-dialog-centered">
                <form className="modal-content modal-content-member p-md-10">
                  ...
                  <label className="fs-5 w-100 mb-4">
                    信用卡號碼：
                    <input className="form-control form-control-addNewSong mt-1" type="text" name="CreditNum" value={this.state.paymentList[0].CreditNum}
                    onChange={
                      (e) => {
                  ...
                  <div className="d-flex mb-4">
                    <label className="fs-5 w-50 me-4">
                      到期日：
                      <input className="form-control form-control-addNewSong mt-1" type="text" name="CreditDeadLine" value={this.state.paymentList[0].CreditDeadLine}
                      onChange={
                        (e) => {
                          let newState = {...this.state};
                    ...
                    <label className="fs-5 w-50">
                      安全驗證碼：
                      <input className="form-control form-control-addNewSong mt-1" type="text" name="CreditSSC" value={this.state.paymentList[0].CreditSSC}
                      onChange={
                        (e) => {
                          let newState = {...this.state};
                  ...
                  <label className="fs-5 w-100 mb-4">
                    持卡者姓名：
                    <input className="form-control form-control-addNewSong mt-1" type="text" name="CreditName" value={this.state.paymentList[0].CreditName}
                    onChange={
                      (e) => {
                        let newState = {...this.state};
                  ...
                  <div className="d-flex justify-content-center">
                    <button type="button" className="btn btn-gradation btn-m me-4 px-md-8" data-bs-dismiss="modal"><span>取消</span></button>
                    <button type="button" className="btn btn-gradation btn-m px-md-8" onClick={this.addOrderClicked}><span>付款</span></button>
                  </div>
                </form>
              </div>
            </div>
