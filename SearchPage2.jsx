...
class SearchPage extends Component {
            ...
            {this.state.searchList.map((item, idx) => (
              <div className="channel_songList row pt-8 pb-8 px-4  border-bottom-secondery heartDiv" idx={item.MusicID}>
                ...
                <div className="col-md-1 m-auto col-1">
                  <button onClick={this.ClickAddMusic} type="button" className="btn hvr-bounce-in" data-num={item.MusicID} data-bs-toggle="modal" data-bs-target="#exampleModal6">
  ...
  componentDidMount = async () => {
    let result = await Axios.get("http://localhost:9000/musicTop");
