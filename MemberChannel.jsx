          ...
          <form className="row align-items-stretch">
            ...
            <div className="col-7 d-flex flex-column">
              ...
              <div className="d-flex justify-content-center">
                <button className="btn btn-gradation btn-m me-4 px-md-10" type="button" data-bs-toggle="modal" data-bs-target="#editCInfo"><span>編輯</span></button>
              </div>
            </div>
          </form>
            ...
            <div className="modal-dialog modal-dialog-member modal-dialog-centered">
              <form className="modal-content modal-content-member p-md-10">
                ...
                <div className="d-flex justify-content-center">
                  ...
                  <button type="button" className="btn btn-gradation btn-m px-md-8" onClick={this.editInfoClicked}><span>確認</span></button>
                </div>
              </form>
            </div>
          </div>
              ...
              <div className="modal fade" id="addNewSong" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                <div className="modal-dialog modal-dialog-member modal-dialog-centered">
                  <form className="modal-content modal-content-member p-md-10">
                    ...
                    <div className="d-flex justify-content-center">
                      <button type="button" className="btn btn-gradation btn-m me-4 px-md-8" data-bs-dismiss="modal"><span>取消</span></button>
                      <button type="button" className="btn btn-gradation btn-m px-md-8" onClick={this.addSongClicked}><span>上傳</span></button>
                    </div>
                  </form>
                </div>
              </div>
                ...
                <div className="modal fade" id={`deleteSong${song.MusicID}`} data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                  <div className="modal-dialog modal-dialog-member modal-dialog-centered">
                    <div className="modal-content modal-content-member p-md-10">
                      ...
                      <div className="d-flex justify-content-center">
                        <button type="button" className="btn btn-gradation btn-m me-4 px-md-8" data-bs-dismiss="modal"><span>取消</span></button>
                        <button type="button" className="btn btn-gradation btn-m px-md-8" onClick={() => { this.deleteSongClicked(song.MusicID) }}><span>確定</span></button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="modal-dialog modal-dialog-member modal-dialog-centered">
                    <div className="modal-content modal-content-member p-md-10">
                      ...
                      <form>
                        ...
                        <div className="d-flex justify-content-center">
                          <button type="button" className="btn btn-gradation btn-m me-4 px-md-8" data-bs-dismiss="modal"><span>取消</span></button>
                          <button type="button" className="btn btn-gradation btn-m px-md-8" onClick={() => { this.replyClicked(message.MessageID) }}><span>回覆</span></button>
                        </div>
                      </form>
                    </div>
                  </div>
