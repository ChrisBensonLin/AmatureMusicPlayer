      ...
      <section className="container pt-md-20">
        ...
        <ul className="d-flex mb-8">
          ...
          <li className="flip ms-4">
            <div className="flip-inner">
              <div className="flip-front">
                <img className="rounded-circle" src="/images/老王樂隊.jpg" alt="嘉賓照片" />
              </div>
              <div className="flip-back text-break p-6">
                <p className="fs-5 fw-bold mb-2">老王樂隊</p>
                <p className="fs-8">枯萎的玫瑰</p>
                <p className="fs-8">這樣就好這樣就好</p>
                <p className="fs-8">日夜無常</p>
              </div>
            </div>
          </li>
          <li className="flip ms-4">
        ...
        <ul className="row pb-30">
          {this.state.ticketList.map((ticket, idx) =>
            <li className="col-md-3 btnClick" idx={ticket.TicketID}>
              <ul className="bg-white rounded-8 p-6">
                <li className="fs-4 fw-bold text-black mb-2">{ticket.TicketSeat}</li>
                <li className="d-flex align-items-center fs-6 text-gray mb-2">
                ...
                <li className="d-flex align-items-center fs-6 text-gray mb-6">
                  <span className="material-icons me-1">confirmation_number</span>
                  票價：NT$ {ticket.TicketPrice}
                </li>
                <NavLink to={`/concert/${ticket.TicketID}`}>
                  <button className="btn btn-gray btn-s w-100 fw-bold" onClick={() => { this.addClass(ticket.TicketID) }}>
                    下一步
                  </button>
                </NavLink>
              </ul>
