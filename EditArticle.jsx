            ...
            <section className="col-md-8">
              <form className="bg-dark-gray rounded-16 p-6">
                ...
                <div className="d-flex justify-content-center">
                  <a href={`/member/channel/${document.cookie}`} type="button" className="btn btn-gradation btn-m me-4 px-md-8"><span>取消</span></a>
                  <button onClick={this.editBlogClicked} type="button" className="btn btn-gradation btn-m px-md-8"><span>確認</span></button>
                </div>
              </form>
            </section>
          </div>
