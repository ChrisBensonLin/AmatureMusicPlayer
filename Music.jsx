...
class Music extends Component {
              ...
              {this.state.albumList.map((item, idx) => (
                <div className=" col-md-2 col-12 ">
                  ...
                  >
                    ...
                    <div className="albumContent p-5">
                      <h5 className="albumTitle hvr-underline-from-center-secondry text-truncate">
                        {item.AlbumName}
                      </h5>
  ...
  componentDidMount = async () => {
    let result = await Axios.get(
      `http://localhost:9000/channelMusic/${this.props.match.params.id}`
    );
