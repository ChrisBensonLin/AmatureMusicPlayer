...
class SearchPage extends Component {
          ...
          <section className="py-20">
            ...
            <div className="d-flex pb-15 border-bottom-secondery">
              <div className="d-flex">
                ...
                <p className="fs-3 ms-3">{this.state.searchList[0].MusicType}</p>
              </div>
              {/* <div>
            ...
            {this.state.searchList.map((item, idx) => (
              <div className="channel_songList row pt-8 pb-8 px-4  border-bottom-secondery heartDiv" idx={item.MusicID} >
                ...
                <div className="col-md-1 m-auto col-1">
                  <button onClick={this.ClickAddMusic} type="button" className="btn hvr-bounce-in" data-num={item.MusicID} data-bs-toggle="modal" data-bs-target="#exampleModal7">
  ...
  componentDidMount = async () => {
    let result = await Axios.get("http://localhost:9000/search/Funk");
