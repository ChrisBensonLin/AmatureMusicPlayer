          ...
          <form className="row align-items-stretch mb-md-12" method="" action="">
            ...
            <div className="col-7 d-flex flex-column">
              ...
              <div className="d-flex justify-content-center">
                <button className="btn btn-gradation btn-m me-4 px-md-10" type="button" data-bs-toggle="modal" data-bs-target="#editUInfo"><span>編輯</span></button>
              </div>
            </div>
          </form>
            ...
            <div className="row">
              ...
              <div className="col-md-6 offset-md-1">
                <ul>
                  ...
                  <li>
                    <button className="btn btn-gradation btn-s active me-4 px-md-4" type="button" idx="2"><span>+ Add New</span></button>
                  </li>
                </ul>
              </div>
            </div>
