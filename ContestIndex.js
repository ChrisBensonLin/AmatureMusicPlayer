...
class ContestIndex extends React.Component {
    render() {
        return (
            <div className='pb-30'>
                <img src="http://localhost:9000/Img/bg-login01.png" alt="" />
                    ...
                    <div>
                        ...
                        <div>
                            <div class="contstBodyRight">
                                <img src="http://localhost:9000/Img/bg-login01.png" class="contestImg" alt="" />
                            </div>
                            <div class="contstBodyRight">
                                <img src="http://localhost:9000/Img/bg-login01.png" class="contestImg" alt="" />
                            </div>
                ...
                <div className='floatclear container mb-3 contestNote contestPart2Note contestIndexBtn'>
                    <NavLink to="/ContestSignUp" className={'btn btn-gradation btn-lg px-4'}>我要報名</NavLink>
                    <NavLink to="/ContestVote" className={'btn btn-gradation btn-lg px-4'}>前往投票</NavLink>
